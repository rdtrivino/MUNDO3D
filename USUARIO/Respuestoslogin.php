                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div id="totalProductos" style="text-align: right; font-weight: bold; color: blue;"><?php echo "Total a pagar: $" . $totalPrecioProductos; ?></div> <!-- Cambia el color del texto, lo alinea a la derecha y lo hace negrita -->
                                            </div>
...
<div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <p>¡Adéntrate en un mundo tridimensional como nunca antes! ¡Bienvenid@ a nuestra página 3D, donde tus sueños cobran vida!</p>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="Repuestoslogin.php"><i class="fa fa-angle-right mr-2"></i>REPUESTOS</a>
