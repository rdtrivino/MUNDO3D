...
<div class="container-fluid pt-5">
    <div class="container">
        <h6 class="text-secondary text-uppercase text-center font-weight-medium mb-3">Nestros Productos</h6>
        <h1 class="display-4 text-center mb-5">Explore e imprima el que mas te guste </h1>
        <div class="row">
            <!-- Producto 1 -->
