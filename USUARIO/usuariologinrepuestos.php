...
<header class="hero">
    ...
    <div class="user-info">
        <button id="user-button">Bienvenido: <span id="user-name"><?php echo $nombreCompleto; ?></span></button>
...
<script>
    ...
    <div class="row">
        <ul class="nav__link nav__link--menu">
            ...
            <li class="nav__items">
                <a href="usuariologincatalogo.php" class="nav__links nav__button">Catalogo</a>
            </li>
            <li class="nav__items">
