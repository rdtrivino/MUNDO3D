...
<head>
    ...
    <link rel="stylesheet" href="../MUNDO 3D/css/Administrador.css">
    <meta charset="UTF-8">
...
<script>
        ...
        // Al cargar la página, verifica si hay un carrito guardado en el almacenamiento local y actualiza el contador
        window.onload = function() {
            var carritoGuardado = localStorage.getItem('carrito');
            var contadorGuardado = localStorage.getItem('contadorCarrito');

            if (carritoGuardado && contadorGuardado) {
                carrito = JSON.parse(carritoGuardado);
                contadorCarrito = parseInt(contadorGuardado);
                document.getElementById('cartCount').innerText = contadorCarrito;
            }
        };
    </script>
    ...
    <header class="hero">
        ...
        <div class="user-controls">
            <div class="user-info">
                <button id="user-button">Bienvenido: <span id="user-name">Usuario</span></button>
            ...
            <div class="logout-icon">
                <img src="../MUNDO 3D/images/bx-exit.svg" alt="Cerrar Sesión" id="logout-button">
            </div>
        </div>
        <script>
        ...
        <nav class="nav container" style="margin-top: 2%;">
    <div class="row">
        <ul class="nav__link nav__link--menu">
            <li class="nav__items">
                <a href="../MUNDO 3D/ADMIN/index.php" class="nav__links nav__button">Inicio</a>
            </li>
            <li class="nav__items">
                <a href="#" class="nav__links nav__button">Repuestos</a>
            </li>
            <li class="nav__items">
