<?php
    session_start();
    $nombreCompleto = $_SESSION["username"]; // Assuming "Usu_Nombre_completo" is stored in "username"
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <ul class="navbar-nav ms-auto ms-auto me-0 me-md-3 my-2 my-md-0">
                ...
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $nombreCompleto; ?><i class="fas fa-user fa-fw"></i></a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#!">Configuracion de cuenta</a></li>
                        <li><hr class="dropdown-divider" /></li>
                        <li><a class="dropdown-item" href="../index.html" id="cerrar-sesion-button">Cerrar sesión</a></li>
                        <script>
                            document.addEventListener("DOMContentLoaded", function () {
                                var cerrarSesionButton = document.getElementById("cerrar-sesion-button");
                                cerrarSesionButton.addEventListener("click", function () {
                                    var confirmCerrarSesion = confirm("¿Estás seguro de que deseas cerrar sesión?");
                                    if (confirmCerrarSesion) {
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">MUNDO 3D</a></li>
