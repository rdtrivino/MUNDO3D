...
$sql_productos = "SELECT p.Pro_Nombre, p.Pro_Codigo, p.Pro_Descripcion, p.Pro_PrecioVenta, c.Cgo_Nombre, p.imagen_principal
                  FROM producto p
                  INNER JOIN categoria c ON p.Pro_Categoria = c.Cgo_Codigo";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE producto SET Pro_Nombre=?, Pro_Descripcion=?, Pro_PrecioVenta=?, Pro_Categoria=?, Pro_Cantidad=?, Pro_Costo=?, imagen_principal=? WHERE Pro_Codigo=?";
