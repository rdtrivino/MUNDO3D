...
<head>
    ...
    <style>
        ...
        #container {
            ...
            justify-content: center;
            position: relative;
            width: 300px; /* Ajusta el ancho del contenedor según tu preferencia */
            height: 300px; /* Ajusta el alto del contenedor según tu preferencia */
        }

        #ring {
            width: 90px; /* Ajusta el ancho del anillo según tu preferencia */
            height: 90px; /* Ajusta el alto del anillo según tu preferencia */
